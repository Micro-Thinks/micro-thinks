        ...
        <div className="container mx-auto mt-4 flex flex-col md:flex-row justify-between">
          ...
          <div className='flex flex-col mt-4 py-2 space-y-2  md:w-1/3'>
            ...
            <div className='flex space-x-4'>
              ...
              />
              <button className='bg-[#F89522] px-6 py-2 rounded-lg'>Submit</button>
            </div>
          </div>

          {/* Need Help Section */}
          <div className='py-4 px-12 space-y-3 md:w-1/3'>
            <h1 className='font-semibold text-2xl tracking-wider'>Need Help?</h1>
            <p className='text-sm'>Manage Booking <br /> Support</p>
          </div>

          {/* Booking Section */}
          <div className='py-4 px-24 space-y-3 md:w-1/3'>
            <h1 className='font-semibold text-xl tracking-wider'>You want to Book?</h1>
